  ...
  return (
    <div className={cn(
      ...
      <div className="mb-3 flex items-start justify-between gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-md bg-muted text-xs font-bold text-foreground shrink-0">
          {item.logo}
        </div>
        {isConnected && (
          <span className="flex items-center gap-1 rounded bg-green-500/15 px-2 py-0.5 text-2xs font-medium text-green-600 dark:text-green-400">
      ...
      <div className="mt-4 flex items-center gap-2">
        {isConnected ? (
          <button className="h-7 rounded-md border border-border px-3 text-xs text-muted-foreground hover:text-foreground hover:bg-accent transition-colors">
            Configure
          </button>
        ) : isComingSoon ? null : (
          <button className="h-7 rounded-md bg-primary px-3 text-xs font-medium text-primary-foreground hover:opacity-90 transition-opacity">
            Connect
          </button>
        )}
        {item.docsUrl && (
