...
function LeadSourcesPage() {
  ...
  useEffect(() => { setMeta({ title: "Lead Sources", subtitle: "Settings" }); }, [setMeta]);
  return <SettingsStub icon={Megaphone} title="Lead Sources" description="Track where your leads come from — referrals, website, Google Ads, and more." />;
}
