...
export const Route = createFileRoute("/settings/item-categories")({
  component: ItemCategoriesPage,
});

function ItemCategoriesPage() {
  const { setMeta } = useMeta();
  useEffect(() => { setMeta({ title: "Item Categories", subtitle: "Settings" }); }, [setMeta]);
  return <SettingsStub icon={Boxes} title="Item Categories" description="Organize your catalog with categories like Parts, Labor, Equipment, and Materials." />;
}
