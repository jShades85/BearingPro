...
export const Route = createFileRoute("/settings/tax-rates")({
  component: TaxRatesPage,
});

function TaxRatesPage() {
  const { setMeta } = useMeta();
  useEffect(() => { setMeta({ title: "Tax Rates", subtitle: "Settings" }); }, [setMeta]);
  return <SettingsStub icon={Percent} title="Tax Rates" description="Configure tax rates by type — labor, parts, equipment — and by jurisdiction." />;
}
